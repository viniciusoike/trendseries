...
- **`index_series()`** rescales one or more series to a common base period and
  value.
...
Each function has its own article on the package website with worked examples,
parameter details, and guidance on choosing between methods.
...
- Check the documentation: `?augment_trends`, `?decompose_series`,
  `?deseason_series`, `?detrend_series`, `?index_series`
- View examples: `example(augment_trends)`
- Browse the articles: <https://viniciusoike.github.io/trendseries/articles/>
