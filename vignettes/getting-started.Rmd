...
coffee_ts <- df_to_ts(coffee_prices, frequency = 12)

# Extract multiple trends
coffee_trends <- extract_trends(
  coffee_ts,
  methods = c("hp", "loess", "ewma"),
  smoothing = 0.2
)

# coffee_trends is a list of time series objects
str(coffee_trends)
```
...
- `coffee_prices`: Monthly coffee price proxy
